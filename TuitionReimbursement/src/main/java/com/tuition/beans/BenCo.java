...
public class BenCo {
	...
	public BenCo(int benco_id, String first_name, String last_name, double tuition_limit, String dhead, int user_id,
			int dept_id) {
		super();
	...
	public String toString() {
		return "BenCo [benco_id=" + benco_id + ", first_name=" + first_name + ", last_name=" + last_name
